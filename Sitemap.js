...
// label.
// ---------------------------------------------------
// Author: Bushido AL Fattah
// Url: https://www.sibolgamedia.com
// Version: 2
// Date: 2018-04-12
// ---------------------------------------------------
...
// this function creates a three-column table and adds it to the screen
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Total Keseluruhan ' + postTitle.length + ' posts<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">Total Keseluruhan ' + numDisplayed + ' posts labeled \'';
